...
class Save extends \VendorNew\ProductList\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('vendorname/productlist');
                        ...
                        $imagePath = 'vendorname/productlist'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('vendorname_productlist/*/edit', ['id' => $model->getId()]);
                    return;
                }
                $this->_redirect('vendorname_productlist/*/');
                return;
            } catch (\Magento\Framework\Exception\LocalizedException $e) {
                $this->messageManager->addError($e->getMessage());
                $id = (int)$this->getRequest()->getParam('id');
                if (!empty($id)) {
                    $this->_redirect('vendorname_productlist/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('vendorname_productlist/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('vendorname_productlist/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('vendorname_productlist/*/');
